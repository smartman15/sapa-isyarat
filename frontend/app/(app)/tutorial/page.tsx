...
const STEPS: Step[] = [
  ...
  { icon:<BookOpen size={18}/>,     iconBg:"bg-[#EEF0F6] text-[#1B1F3B]",   title:"Kamus SIBI",               description:"Cari kata di tab Kamus. Setiap kata dilengkapi video demonstrasi gerakan tangan, pelafalan, dan contoh penggunaan.",                                               tip:"Simpan kata ke Favorit agar mudah ditemukan lagi.",                                    mascotMood:"wave",    mockup:<MockDictionary/>  },
